  ...
  <div class="layuimini-main layui-row content-body">
    <div class="layui-col-lg8 layui-col-md-offset2">
        ...
        <form class="layui-form layui-form-pane">
            ...
            <blockquote class="layui-elem-quote" style="margin-top: 10px;border-left: 5px solid #FF5722; color: #FF5722;" id='guide'>第一步:请上传数据,支持: db3 / html 格式(最大10M),使用前请参考<a href="https://github.com/iuaihub/IuaiNav/wikis/pages?sort_id=7968661&doc_id=3767990" target="_blank" rel = "nofollow">帮助文档</a></blockquote>
...
layui.use(['layer','element','upload','form','table'], function(){
    ...
    table.on('toolbar(list)', function(obj){
        ...
        if(obj.event == 'local_backup'){
            ...
            window.open('https://github.com/iuaihub/IuaiNav/wikis/pages?sort_id=7968661&doc_id=3767990');
        }
    });
    //行事件
