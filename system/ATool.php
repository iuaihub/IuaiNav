...
<div class="page-wrapper">
    ...
    <div class="layui-btn-container" style="display: inline-block;">
        ...
        <a class="layui-btn layui-btn-sm layui-btn-primary" href="https://github.com/iuaihub/IuaiNav/wikis/pages?sort_id=7993451&doc_id=3767990" target="_blank"><i class="layui-icon layui-icon-align-left"></i>帮助</a>
    </div>
    <hr>
